...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: [
                    'yithwebclient/static/js/app.js', 'yithwebclient/static/js/models.js', 'yithwebclient/static/js/controllers.js', 'yithwebclient/static/js/objects.js', 'yithwebclient/static/js/views.js'
                ],
